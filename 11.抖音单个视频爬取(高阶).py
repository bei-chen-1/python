"""
[课程内容]:Python实现批量下载抖音视频内容https://www.douyin.com/
...
先听一下歌 等一下后面进来的同学，20:05正式开始讲课[有什么喜欢听得歌曲也可以在公屏发一下]
相对应的安装包/安装教程/激活码/使用教程/学习资料/工具插件可以加木子老师微信python10080
---------------------------------------------------------------------------------------------------------------------------------------------
爬虫实现基本流程
一.数据来源分析
1.明确需求
（1）明确采集的网站以及数据内容
·网址: https://www.douyin.com/user/MS4wLjABAAAArcoz8pyUJSASISQnP_JMfUgNATaCTOJJzQsG6HSzeAU?from_tab_name=main&modal_id=7440465989214489882
·数据:视频内容/视频标题
2.抓包分析
（1）通过浏览器开发者工具分析对应的数据位置
抓包流程操作是在浏览器中进行操作:谷歌浏览器
●打开开发者工具
...
·通过关键字搜索找到对应的数据位置
    关键字：需要什么数据就搜什么数据
        开发者工具--->网络--->媒体--->查看对应视频链接地址
        以链接中的一段参数进行搜索
数据包地址：https://www.douyin.com/user/MS4wLjABAAAArcoz8pyUJSASISQnP_JMfUgNATaCTOJJzQsG6HSzeAU?from_tab_name=main&modal_id=7440465989214489882
二.代码实现步骤
1.发送请求
模拟浏览器对于url地址发送请求
...
# 请求网址
url = 'https://www.douyin.com/user/MS4wLjABAAAArcoz8pyUJSASISQnP_JMfUgNATaCTOJJzQsG6HSzeAU?from_tab_name=main&modal_id=7440465989214489882'
